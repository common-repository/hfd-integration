...
class Home_Delivery extends \WC_Shipping_Method
{
    ...
    public function __construct($instanceId = 0)
    {
        ...
        $this->method_title = __('משלוח איסוף מלקוח קצה', HFD_WC_EPOST);
        $this->method_description = __('משלוח איסוף מלקוח קצה', HFD_WC_EPOST);
        $this->supports = array(
            'shipping-zones',
            'instance-settings',
    ...
    public function init()
    {
        ...
        $this->instance_form_fields = array(
            'enabled' => array(
                'title' => __('Enable/Disable', HFD_WC_EPOST),
                'type' => 'checkbox',
                'label' => __('Enable this shipping method', HFD_WC_EPOST),
                'default' => 'yes',
            ),
            'title' => array(
                'title' => __('משלוח איסוף מלקוח קצה', HFD_WC_EPOST),
                'type' => 'text',
                'default' => __('משלוח איסוף מלקוח קצה', HFD_WC_EPOST),
                'desc_tip' => true
            ),
            'shipping_fee' => array(
                'title' => __('Shipping fee', HFD_WC_EPOST),
                'type' => 'number',
                'default' => 0
            ),
        );
