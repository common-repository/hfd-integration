...
class Epost extends \WC_Shipping_Method
{
    ...
    public function __construct($instanceId = 0)
    {
        ...
        $this->method_title = __('Epost', HFD_WC_EPOST);
        $this->method_description = __('Epost', HFD_WC_EPOST);
        $this->supports = array(
            'shipping-zones',
            'instance-settings',
    ...
    public function init()
    {
        ...
        $this->instance_form_fields = array(
            ...
            'title' => array(
                'title' => __('Epost', HFD_WC_EPOST),
                'type' => 'text',
                'default' => __('Epost', HFD_WC_EPOST),
                'desc_tip' => true
            ),
            'shipping_fee' => array(
			...
			'free_shipping_over' => array(
                'title' => __( 'Free shipping over', HFD_WC_EPOST),
                'type' => 'number',
                'default' => 0
            ),
        );
