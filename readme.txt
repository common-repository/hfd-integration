...
Tags: woocomerce, sync, hfd, epost, shipping, israel
Donate link: 
...
= 2.0 =
* הוספת תמיכה ב hooks עבור מתכנתים
= 1.8 =
* שינוי צורת יישוב איפוסט
= 1.7 =
* עדכון מדריך לשימוש ומסוף טסטים
= 1.6 =
* הוספת אימות בעת בקשה לביטול משלוח
= 1.5 =
* תיקון שגיאת SSL נקודות איסוף
= 1.4 =
* עדכון מעבר סנכרונים בלינק מאובטח פרוטוקול HTTPS
= 1.3 =
* שינוי טקסטים והוספת משלוח לאיסוף
= 1.2 =
